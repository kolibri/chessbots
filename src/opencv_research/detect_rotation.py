...
def point_in_area(point: [int, int], area: [[int, int], [int, int]]) -> bool:
    res = area[0][0] < point[0] < area[1][0] and area[0][1] < point[1] < area[1][1]
    return res
...
class Captcha:
    def __init__(self, img_path: str):
        ...
        self.__templates = [
            ['images/pattern_WO.png', 0],
            ['images/pattern_WX.png', 1],
            ['images/pattern_BO.png', 0],
            ['images/pattern_BX.png', 1]
        ]
...
captcha = Captcha('images/rotation_base.png')

# print('matches', captcha.find_matches())
# print('angle', captcha.calculate_angel())
# print('grid', captcha.find_grid())
print('board', captcha.get_txt_captcha())

cv2.imwrite('images/rotation_out_grid.png', captcha.get_img_grid())
cv2.imwrite('images/rotation_out_matches.png', captcha.get_img_matches())
cv2.imwrite('images/rotation_out_angle.png', captcha.get_img_angle())
